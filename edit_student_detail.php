        ...
        <div class="row">
           <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="form-group">
                ...
                <input type="text" name="father_mother_name" placeholder="Enter your Father/Mother name" class="form-control"  value="<?php echo $row['father_mother_name'] ?>" >  
            </div>
           ...
           <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="form-group">
                ...
                <input type="text" name="mobile" placeholder="Enter your Mobile number" class="form-control"  ass="input-group">
                
                <div class="input-group-prepend"> <span class="input-group-text" id="inputGroupFileAddon01">Upload</span> </div>
                <div class="custom-file">
                <input type="file" name="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFile01" name="image">
...
if(isset($_POST['update'])){
    ...
    $father_mother_name = mysqli_real_escape_string($conn,$_POST['father_mother_name']);
               ...
               $image = $_FILES['image']['name'];
                $image_type = $_FILES['image']['type'];
                 $image_size = $_FILES['image']['size'];
                  ...
                  $image_query = "select * from add_student where st_id = '$edit_st_id'";
                  ...
                  if(!$image_type == 'image/jpg' or !$image_type == 'image/png'){
                    ...
                    move_uploaded_file($image , "st_image/$image");
                $sql = "update add_student set fname = '$fname' , lname = '$lname' , father_mother_name = '$father_mother_name' , gender = '$gender' , email = ' $email' , birthdate = ' $birthdate' , address = '$address' , mobile = '$mobile' , image = '$image' where st_id = '$edit_st_id'";
