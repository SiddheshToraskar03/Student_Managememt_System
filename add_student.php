         ...
         $address = mysqli_real_escape_string($conn,$_POST['address']);
          $mobile = mysqli_real_escape_string($conn,$_POST['mobile']);
               ...
               $image = $_FILES['custom-file-input']['name'];
                ...
                $sql = "insert into `add_student` (fname,lname,father_mother_name,gender,email,birthdate,address,mobile,image) values ('$fname','$lname','$father_mother_name','$gender','$email','$birthdate','$address','$mobile','$image')";
