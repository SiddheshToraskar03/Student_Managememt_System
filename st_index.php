...
<section class="">
    ...
    <div class="container bg-danger" id="formsetting">
    	<h3 class="text-white text-center py-3">STUDENT LOGIN PANEL</h3> 
    	<!--row star--->
    	<div class="row">
...
if(isset($_POST['submit'])){
    ...
    if($pwd_decode){
        echo "<script>window.open('st_dashboard.php?success=Logged in successfully', '_self')</script>";
    }
    else{
        echo "<script>window.open('__?error=Username or password is incorrect', '_self')</script>";
    }
}
?>